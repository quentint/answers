...
if(class_exists('qTranslateWidget') && function_exists('qtrans_generateLanguageSelectCode_custom')){
	class qTranslateWidget_Extended extends qTranslateWidget {
		...
		function widget($args, $instance) {
			...
			qtrans_generateLanguageSelectCode_custom($type, $this->id);
			echo $after_widget;
		}
	}
	add_action('widgets_init', create_function('', 'return register_widget("qTranslateWidget_Extended");'));
}
